...
typedef struct{
	...
	unsigned short Slave_Device_Car_ONLINE[DEVICESNUM];
	unsigned short Slave_Device_Servo_ONLINE[DEVICESNUM];
	unsigned short Slave_Device_ONLINE[DEVICESNUM];
	int status;
	unsigned int maxId;
}Slave_Devices_Stu;
extern Slave_Devices_Stu Slave_Device;
